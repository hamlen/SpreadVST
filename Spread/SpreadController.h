...
static const FUID SpreadControllerUID(0x152C7B8D, 0x71604051, 0x8FD3A939, 0x17EB5369);

class SpreadController : public EditController, public IMidiMapping
{
public:
	SpreadController(void);

	static FUnknown* createInstance(void* context)
	{
		return (IEditController*) new SpreadController;
	}
